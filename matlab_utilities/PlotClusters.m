...
%
%   PlotClusters(DATA, IDX, CENTERS, ISTANCES) additionally, allows you to
%   specify the number of istances of the dataset.
%
% Example:
% --------
...
function []=PlotClusters(Data,IDX,Centers,Instances)
%Checking inputs
switch nargin
